...
*The full experimental record - every script, raw output, pre-registration, and lab-notebook volume - is at [github.com/mac-n/lakoff-schemas-in-transformers](https://github.com/mac-n/lakoff-schemas-in-transformers).*
...
The standing rule of the project: when a finding seems big, name the control that would falsify it, then run it. The [accompanying repository](https://github.com/mac-n/lakoff-schemas-in-transformers) contains every experiment script, raw output, pre-registration, and lab-notebook volume, including the failures.

The research was conducted as a collaboration between the author and Claude (Anthropic) across many sessions.

---

*Niamh McCombe, 2026. Lab notebook and experiment code at [github.com/mac-n/lakoff-schemas-in-transformers](https://github.com/mac-n/lakoff-schemas-in-transformers).*
